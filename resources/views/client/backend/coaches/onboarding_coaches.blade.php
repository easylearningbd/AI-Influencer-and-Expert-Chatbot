...
<form action=" " method="POST">
    ...
    <div class="mb-3"> 
        ...
        <textarea class="form-control" name="skills_text" rows="3">{{ old('skills_text',$profil && $profile->skills ? implode("\n",$profile->skills) : '') }}</textarea>
    ...
    <div class="row">
        <div class="col-md-4 mb-3">
            ...
            <input type="number" step="0.01" class="form-control" name="height" value=" ">
        </div>
        <div class="col-md-4 mb-3">
            <label class="form-label">Weight (kg)</label>
            <input type="number" step="0.01" class="form-control" name="weight" value=" ">
        </div>
        <div class="col-md-4 mb-3">
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control" name="fitness_goals" rows="3"> </textarea>
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="number" step="0.01" class="form-control" name="monthly_income" value=" ">
    </div>
    <div class="mb-3">
        <label class="form-label">Monthly Expenses ($)</label>
        <input type="number" step="0.01" class="form-control" name="monthly_expenses" value=" ">
    </div>
    <div class="mb-3">
        <label class="form-label">Current Savings ($)</label>
        <input type="number" step="0.01" class="form-control" name="savings" value=" ">
    </div>
    <div class="mb-3">
        <label class="form-label">Current Debt ($)</label>
        <input type="number" step="0.01" class="form-control" name="debt" value=" ">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <textarea class="form-control" name="dietary_restrictions_text" rows="3"> </textarea>
    </div>
    <div class="mb-3">
        <label class="form-label">Food Allergies (one per line)</label>
        <textarea class="form-control" name="food_allergies_text" rows="3"> </textarea>
    </div>
    <div class="mb-3">
        <label class="form-label">Daily Calorie Goal</label>
        <input type="number" class="form-control" name="daily_calorie_goal" value=" " placeholder="2000">
    </div>
